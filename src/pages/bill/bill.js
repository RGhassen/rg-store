...
const Bills = () => {
  ...
  const getAllBills = async () => {
    try {
      ...
      const {data} = await axios.get('http://localhost:5000/api/bills/getbills');
      setBillsData(data);
      dispatch({
        type: "HIDE_LOADING",
      });
        ...
        <Modal title="Invoice Details" width={400} pagination={false} visible={popModal} onCancel={() => setPopModal(false)} footer={false}>
          <div className="card" ref={componentRef}>
            <div className="cardHeader">
                <h2 className="logo">RG Store</h2>
                <span>Number: <b>+216 26 196 197</b></span>
                <span>Address: <b>4100 Mednine, Tunisia</b></span>
            </div>
            <div className="cardBody">
                ...
                <div className="group">
                    ...
                    <span><b>{selectedBill.totalAmount} DT</b></span>
                </div>
            </div>
            <div className="cardFooter">
                ...
                {selectedBill.cartItems.map((product) => (
                    <>
                        <div className="footerCard">
                            ...
                            <div className="group">
                                <span>Price:</span>
                                <span><b>{product.price} DT</b></span>
                            </div>
                        </div>
                    </>
                ))}
                <div className="footerCardTotal">
                    <div className="group">
                        <h3>Total:</h3>
                        <h3><b>{selectedBill.totalAmount} DT</b></h3>
                    </div>
                </div>

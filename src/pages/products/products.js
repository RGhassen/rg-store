...
const Products = () => {
  ...
  const handlerDelete = async (record) => {
    try {
      ...
      await axios.post('http://localhost:5000/api/products/deleteproducts', {productId:record._id});
  ...
  const handlerSubmit = async (value) => {
    ...
    if(editProduct === null) {
      try {
        ...
        const res = await axios.post('http://localhost:5000/api/products/addproducts', value);
      ...
      try {
       ...
       await axios.put('http://localhost:5000/api/products/updateproducts', {...value, productId:editProduct._id});
